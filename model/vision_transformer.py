...
from .layers import PatchEmbed, Mlp, DropPath, trunc_normal_, lecun_normal_, resample_patch_embed, \
...
class VisionTransformer(nn.Module):
    ...
    def __init__(
        ...
        # self.mlp = torch.nn.Sequential(torch.nn.Linear(in_c, embed_dim), 
        #                                 torch.nn.LayerNorm(embed_dim),
        #                                 torch.nn.LeakyReLU(0.2)
        #                                 )
        # self.linear = torch.nn.Linear(embed_dim, 1, bias=False)
